...
class ProductionData(models.Model):
    ...
    clientName  = models.ForeignKey(CustomerDetail,on_delete=models.CASCADE,null=True,blank=True)
    # client_id = models.ForeignKey(CustomerDetail,on_delete=models.CASCADE,null=True,blank=True)
    value = models.CharField(max_length=50,null=True,blank=True)
    moc = models.ForeignKey(Moc,on_delete=models.CASCADE,null=True,blank=True)
    toolType = models.ForeignKey(ToolType,on_delete=models.CASCADE,null=True,blank=True)
    shape = models.ForeignKey(Shape,on_delete=models.CASCADE,null=True,blank=True)
    tabletSize = models.ForeignKey(TabletSize,on_delete=models.CASCADE,null=True,blank=True)
    u1 = models.ForeignKey(U1,on_delete=models.CASCADE,null=True,blank=True)
    u2 = models.ForeignKey(U2,on_delete=models.CASCADE,null=True,blank=True)
    l1 = models.ForeignKey(L1,on_delete=models.CASCADE,null=True,blank=True)
    l2 = models.ForeignKey(L2,on_delete=models.CASCADE,null=True,blank=True)
    d = models.ForeignKey(D,on_delete=models.CASCADE,null=True,blank=True)
    set = models.ForeignKey(Set,on_delete=models.CASCADE,null=True,blank=True)
    platingType = models.ForeignKey(PlatingType,on_delete=models.CASCADE,null=True,blank=True)
    rawMaterial = models.ForeignKey(RawMaterial,on_delete=models.CASCADE,null=True,blank=True)
    ...
    punchBlankUsed = models.ForeignKey(PunchBlank,on_delete=models.CASCADE,null=True,blank=True)
    dieBlankUsed = models.ForeignKey(DieBlank,on_delete=models.CASCADE,null=True,blank=True)
    ...
    blank = models.ForeignKey(Blank,on_delete=models.CASCADE,null=True,blank=True)
    process = models.ForeignKey(Process,on_delete=models.CASCADE,null=True,blank=True)
    bodyTipMachining = models.ForeignKey(BodyTipMachining,on_delete=models.CASCADE,null=True,blank=True)
    headMachining = models.ForeignKey(HeadMachining,on_delete=models.CASCADE,null=True,blank=True)
    keywayTaperFinish = models.ForeignKey(KeywayTaperFinish,on_delete=models.CASCADE,null=True,blank=True)
    ht = models.ForeignKey(HT,on_delete=models.CASCADE,null=True,blank=True)
    grinding = models.ForeignKey(Grinding,on_delete=models.CASCADE,null=True,blank=True)
    hardChrome = models.ForeignKey(HardChrome,on_delete=models.CASCADE,null=True,blank=True)
    qualityCheck = models.ForeignKey(QualityCheck,on_delete=models.CASCADE,null=True,blank=True)
    packingDispach = models.ForeignKey(PackingDispach,on_delete=models.CASCADE,null=True,blank=True)
